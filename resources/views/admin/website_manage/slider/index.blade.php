                ...
                <div class="title_right">
                    <div class="col-md-12 col-sm-12 form-group top_search">
                        <button data-toggle="modal" data-target=".add_slider" type="button" class="btn btn-info btn-sm pull-right">
                            <i class="fa fa-plus fs-13 m-r-3"></i> Add New Slider
                        </button>
                    </div>
                </div>
            </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      	<div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Create new slider
	    ...
	    <div class="modal-body">
	    	<form id="slider_form" method="post" enctype="multipart/form-data">@csrf
	    		@include('admin.website_manage.slider.form') <br>
	    		<span class="form_result"></span>
	    		<button class="btn btn-info pull-right" type="submit"><i class="fa fa-check"></i> Save Slider</button>
	    	</form>
	    </div>
    </div>
  </div>
...
<div class="modal fade edit_slider" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Slider
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button> </h5>
        </div>
        <div class="modal-body">
            <form action="{{route('update-slider')}}" id="edit_slider" method="post" enctype="multipart/form-data">@csrf
              	@include('admin.website_manage.slider.form')<br><br>
                <span class="form_result2"></span>
                <input type="hidden" name="id">
                <input type="hidden" name="oldLogo">
                <button class="btn btn-info pull-right" type="submit"><i class="fa fa-edit"></i> Update Slider</button>
            </form>
        </div>
    </div>
  </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            let table = $('.table').DataTable({
                ...
                serverSide: true,ajax: "{{route('sliders')}}",
                order: [ [0, 'desc'] ],
                columns: [
                    {data: 'slider_title'},{data: 'description'}, {data: 'status'},

                                ...
                                @foreach($user as $users)
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row">
                                            ...
                                            @else
                                                <span
                                                    class="label label-success">{{$users->created_at->diffForHumans()}}</span>
                                            @endif
                                        </th>
                                        <th scope="row">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Merchant Information add</small>
                            </h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            ...
                            <form id="demo-form2" method="post"
                                  action="{{route('merchant.store')}}" autocomplete="off"
                                ...
                                <div class="col-xs-12 form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" placeholder="Example: Daraz"
                                           name="shop_name"
                                           id="shop_name"
                                           value="{{old('shop_name')}}">
                                </div>

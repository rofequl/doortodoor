                        ...
                        <div class="x_content">
                            ...
                            <form id="upload_form" autocomplete="off" method="post"
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <select class="col-md-7 col-xs-12 select2_single" name="hub_id"
                                            id="hub_id">
                                        <option></option>
                                    </select>
                                </div>
    ...
    <script>
        ...
        $('#zone_id').change(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#hub_id').html('').append($('<option>', {value: '', text: 'Select Hub'}));
                    data.forEach(function (element) {
                        $('#hub_id').append($('<option>', {value: element.id, text: element.name}));
                    });
                }
            });
        });
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.edit', function () {
                $('#myModal').modal('show');
                $('.modal-header').html('Area Information Edit');
                $("#upload_form").trigger("reset");
                let id = $(this).attr('id');
                $.ajax({

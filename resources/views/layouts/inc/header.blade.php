        ...
        <div class="theme-container container">
            <div class="row">
                <div class="col-md-2 col-sm-12">
                    <a class="navbar-logo" href="#"> <img src="{{asset('storage/logo/'.basic_information()->company_logo)}}" alt="logo"/> </a>
                </div>
        ...
        <div class="theme-container container">
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12 fs-12">
                    <a class="sticky-logo hidden-sm" href="index.html"> <img alt="" width="115"
                    ...
                    <div id="navbar" class="collapse navbar-collapse no-pad">
                        <ul class="navbar-nav theme-menu">
                            ...
                            <li class="{{ (request()->is('about')) ? 'active' : '' }}"><a href="{{route('about')}}">
                                    pricing </a></li>

                    ...
                    <form method="post" action="{{route('ProfileUpdate')}}" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center mb-4">
                            <div class="col-md-3 col-12" onclick="chooseFile()" style="cursor: pointer">
                                <img
                                    src="{{Auth::guard('user')->user()->image==null? asset('images/user.png'):asset('storage/user/'.Auth::guard('user')->user()->image)}}"
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="exampleEmail11"
                                        ...
                                        name="phone" id="exampleEmail11" value="{{Auth::guard('user')->user()->phone}}"
                                        type="text"
                                        class="form-control"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="shop_name"
                                                                                 class="">Shop Name</label><input
                                        name="shop_name" id="shop_name"
                                        value="{{Auth::guard('user')->user()->shop_name}}" type="text"
                                        class="form-control" required max="255"></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="website_link"
                                                                                 class="">Page / Website
                                        Link</label><input

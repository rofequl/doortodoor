...
@section('content')
    <article>
        ...
        <section class="calculate pt-100">
            <div class="theme-container container">
                    <span class="bg-text right wow fadeInUp" data-wow-offset="50"
                          data-wow-delay=".20s"> calculate </span>
                <div class="row">
                    <div class="col-md-6 text-center">
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-content">
                            <p class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s"><i
                                    ...
                                    <br> facilisis at vero eros et accumsan et iusto odio dignissim qui blandit
                    ...
                    <div class="col-md-6 col-sm-8">
                        ...
                        <ul class="contact-detail title-2">
                            <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".20s">
                                ...
                                <p class="gray-clr"> +001-2463-957 <br> +001-4356-643 </p></li>
                            ...
                            <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".30s"><span>Email address:</span>
                                <p class="gray-clr"> support@go.com <br> info@go.com </p></li>
                        </ul>
                    </div>
                </div>
            </div>

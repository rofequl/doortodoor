...
class AreaController extends Controller
{
    ...
    {
        return DataTables::of(Zone::orderBy('id', 'DESC')->get())->addColumn('action', function ($country) {
            return '
            <div class="btn-group  btn-group-sm">
                        <button class="btn btn-success edit" id="' . $country->id . '" type="button"><i class="mdi mdi-table-edit m-r-3"></i>Edit</button>
                        <button class="btn btn-success delete" id="' . $country->id . '" type="button"><i class="mdi mdi-delete m-r-3"></i>Delete</button>
    ...
    {
        return DataTables::of(Area::orderBy('id', 'DESC')->get())->addColumn('action', function ($country) {
            return '
            <div class="btn-group  btn-group-sm">
